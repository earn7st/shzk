...
namespace shzk
{
	class DepthPrePass : public MeshPass
	{
	public:
		DepthPrePass() : MeshPass(PassType::DepthPre) {}
	...
	class DepthPrePassProcessor : public MeshPassProcessor
	{
	public:
		DepthPrePassProcessor() = delete;
		DepthPrePassProcessor(DepthPrePass* pass);
		~DepthPrePassProcessor() = default;
